...
from keras.layers import add, Conv2D, Input, BatchNormalization, \
     TimeDistributed, Embedding, LSTM, GRU, Dense, MaxPooling1D, \
     Dropout, LeakyReLU, ReLU, Flatten, concatenate, Bidirectional
...
def InstantiateModel(in_):
    ...
    model_2_1 = GRU(
        ...
        activation=None,
        go_backwards=True)(in_)
    model_2 = LeakyReLU()(model_2_1)
    model_2 = GRU(
        128,
        return_sequences=True,
        activation=None,
        go_backwards=True)(model_2)
    ...
    model_5 = GRU(
        ...
        return_sequences=True,
        activation=None,
        go_backwards=True)(model_add_1)
    model_5 = LeakyReLU()(model_5)
    model_5 = GRU(
        32,
        return_sequences=True,
        activation=None,
        go_backwards=True)(model_5)
    model_5 = LeakyReLU()(model_5)
